...
import { buildQueryString, registerRateLimitPolicy, resetRateLimitState, } from "./rest-fetch";
...
describe("registerRateLimitPolicy", () => {
    ...
    it("registers a policy without error", () => {
        expect(() => registerRateLimitPolicy({ key: "test-api", minIntervalMs: 500 })).not.toThrow();
    });
...
//# sourceMappingURL=rest-fetch.test.js.map